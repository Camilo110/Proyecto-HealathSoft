 ...
 * @author adolf
 */
public class InicioSesionAfiliado extends javax.swing.JFrame {

    /**
     * Creates new form InicioSesionAdmin
     */
    public InicioSesionAfiliado() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InicioSesionAfiliado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InicioSesionAfiliado().setVisible(true);
            }
        });
    }
