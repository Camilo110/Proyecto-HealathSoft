 ...
 * @author adolf
 */
public class InicioSesionBanco extends javax.swing.JFrame {

    /**
     * Creates new form InicioSesionAdmin
     */
    public InicioSesionBanco() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Gestores de Pagos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InicioSesionBanco.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InicioSesionBanco().setVisible(true);
            }
        });
    }
